...
def main():
    parser = argparse.ArgumentParser(description="Generate a YAML file with specified configuration for precision models.")
    ...
    parser.add_argument("--model_architecture", default="precision", help="Model architecture.")
    ...
    parser.add_argument("--cutoff_lr", type=float, default=10.0, help="Cutoff MM-QM polarization [A].")
    ...
    parser.add_argument("--n_steps", type=int, default=3, help="Number of message passing steps.")
    ...
    parser.add_argument("--n_channels", type=int, default=64, help="Number of multipoles per atom.")
    parser.add_argument("--n_kernels", type=int, default=20, help="Number of Bessel function used to encode the distance between QM-QM particles.")
